...
export const TimeLineData = [
  {
    year: 2017,
    text: "Graduated from National Hsinchu Senior High School (HCHS)",
  },
  {
    year: 2017,
    text: "Got admitted to Fu Jen Catholic University Philosophy as 'Top 3 positive take'",
  },
  {
    year: 2022,
  ...
  {
    year: 2022,
    text: "Obtain multiple offical certifications e.g. Google Analytics Individual Qualification, Google Ads Certifications, Microsoft MTA: Introduction to Programming Using Python",
  },
  {
    year: 2023,
    text: "Accomplish several projects, and look forward to more opportunities to enhence programming skills.",
  },
];
